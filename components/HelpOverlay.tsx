          ...
          >
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-2">
                ...
                <h2 className="font-cinzel text-lg text-[#3d3228]">Field Reference</h2>
              </div>
            ...
            <div className="space-y-3">
              {SHORTCUTS.map((s) => (
                <div key={s.key} className="flex items-center justify-between py-2 border-b border-[rgba(62,50,40,0.08)] last:border-0">
                  ...
                  <kbd className="px-2 py-1 bg-[rgba(90,78,66,0.08)] border border-[rgba(122,107,82,0.2)] rounded text-[11px] font-mono text-[#5a4e42]">
                    {s.key}
                  </kbd>
                </div>
              ))}
            ...
            <p className="mt-6 text-[11px] font-mono text-[#9a8a72] text-center uppercase tracking-wider">
