...
const SEEDED_ARTIFACTS: PhysicalArtifact[] = [
  {
    ...
    markings: [ {
        id: "mark-coils",
        type: "inscription",
        description: "Microscopic geodetic vector codes engraved into the terminal coils.",
        location: "interior",
  ...
  },
  {
    ...
    markings: [ {
        id: "mark-fractures",
        type: "damage",
        description: "Subaudible frequency patterns physically etched into the quartz grain boundaries.",
        location: "surface",
  ...
  },
  {
    ...
    markings: [ {
        id: "mark-hands",
        type: "symbol",
        description: "Charred silver hands fused directly onto the pocketwatch dial.",
        location: "dial face",
        requiresMagnification: false,
        requiresUV: true,
