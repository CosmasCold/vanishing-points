...
// ─── BOOT LINES ───
const LINES = [
  { text: 'POWER RESTORED', type: 'system', delay: 600 },
  { text: '', type: 'spacer', delay: 300 },
  { text: 'Loading Archive Kernel...', type: 'info', delay: 900 },
  { text: '  [OK]  Kernel v4.2.1-stable', type: 'ok', delay: 280 },
  { text: '  [OK]  Memory banks 1–16', type: 'ok', delay: 220 },
  { text: '  [OK]  Magnetic drum array', type: 'ok', delay: 380 },
  { text: '', type: 'spacer', delay: 350 },
  { text: 'Initializing Atlas...', type: 'info', delay: 1000 },
  { text: '  [OK]  Geodetic reference frame loaded', type: 'ok', delay: 280 },
  { text: '  [OK]  159 locations indexed', type: 'ok', delay: 220 },
  { text: '  [WARN]  Coordinate drift in sector 7-B', type: 'warn', delay: 550 },
  { text: '', type: 'spacer', delay: 350 },
  { text: 'Checking Integrity...', type: 'info', delay: 800 },
  { text: '  [OK]  Document repository', type: 'ok', delay: 220 },
  { text: '  [OK]  Evidence chain verified', type: 'ok', delay: 220 },
  { text: '  [OK]  BUNKER_7 relay stable', type: 'ok', delay: 350 },
  { text: '', type: 'spacer', delay: 350 },
  { text: 'Loading Investigations...', type: 'info', delay: 700 },
  { text: '  [OK]  3 active cases', type: 'ok', delay: 220 },
  { text: '  [OK]  1 pending review', type: 'ok', delay: 220 },
  { text: '', type: 'spacer', delay: 350 },
  { text: 'Synchronizing Evidence...', type: 'info', delay: 800 },
  { text: '  [OK]  Cross-reference matrix built', type: 'ok', delay: 320 },
  { text: '', type: 'spacer', delay: 350 },
  { text: 'Loading Local Cache...', type: 'info', delay: 600 },
  { text: '  [OK]  847 artifacts recovered', type: 'ok', delay: 220 },
  { text: '', type: 'spacer', delay: 450 },
  { text: 'Dust Index: STABLE', type: 'ok', delay: 700 },
  { text: '', type: 'spacer', delay: 700 },
  { text: 'Good evening, Investigator.', type: 'final', delay: 2200 },
];
...
export const BootSequence: React.FC = () => {
  ...
  // If boot is complete, don't render at all
