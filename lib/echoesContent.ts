...
export const NUMBERS_STATIONS = [
  ...
  { freq: 105.5, text: "The green light is not a light. It is an eye.", code: null },
...
export const UNSENT_MESSAGES = [
  ...
  "bunker seven is not underground it is between",
  ...
  "do not click on the green marker",
...
export const BUNKER_TRANSMISSIONS = [
  ...
  "BUNKER_7: The green light is not a light. It is an eye.",
